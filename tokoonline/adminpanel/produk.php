    ...
    <nav aria-label="breadcrumb">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div>
                ...
                <input type="text" id="nama" name="nama" class="form-control" outocomplete="off" 
                required>
            </div>
            <div>
            ...
            <?php
                if(isset($_POST['simpan'])) {
                    ...
                    <?php
                        ...
                        $queryTambah = mysqli_query($conn, "INSERT INTO
                        ...
                        if($queryTambah){
                            ?>
                                ...
                                <meta http-equiv="refresh" content="2; produk.php"/>
                            <?php
                        }
                        else{
